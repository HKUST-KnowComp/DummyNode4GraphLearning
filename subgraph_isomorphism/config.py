...
def _add_hgt_config(parser):
    parser.add_argument(
        "--rep_hgt_batch_norm",
        type=str2bool,
        default=False,
        help="batch normalization in HGT"
    )
    ...
    parser.add_argument(
        ...
        default="diag",
        choices=["none", "basis", "bdd", "diag", "scalar"],
        help="regularizer in relation decomposition in HGT"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="number of bases in decomposition in HGT"
    )
...
def add_rep_net_config(parser):
    ...
    _add_hgt_config(parser)

    parser.add_argument(
        "--rep_net",
        type=str,
        default="CNN",
        choices=["CNN", "RNN", "TXL", "RGCN", "RGIN", "CompGCN", "DMPNN", "LRP", "DMPLRP", "HGT"],
...
def add_data_config(parser):
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="whether to add dummy nodes and edges"
    )
