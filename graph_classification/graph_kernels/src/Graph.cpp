...
Graph::Graph(const bool directed)
    : m_is_directed(directed), m_num_nodes(0), m_num_edges(0), m_node_labels(), m_edge_labels(), m_vertex_id(),
      m_local(), m_node_to_two_tuple(), m_node_to_three_tuple()
{
}
...
Graph::Graph(const bool directed, const uint num_nodes, const EdgeList &edgeList, const Labels node_labels)
    : m_is_directed(directed), m_adjacency_lists(), m_num_nodes(num_nodes), m_num_edges(edgeList.size()),
      m_node_labels(node_labels), m_edge_labels(), m_vertex_id(), m_local(), m_node_to_two_tuple(),
