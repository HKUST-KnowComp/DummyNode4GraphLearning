...
class GenerateTwo
{
  public:
    ...
    Graph generate_local_graph(const Graph &g, const bool use_node_labels, const bool use_edge_labels);
    Graph generate_local_graph_connected(const Graph &g, const bool use_node_labels, const bool use_edge_labels);

    GramMatrix generate_local_sparse_am(const Graph &g, const bool use_node_labels, const bool use_edge_labels);
    vector<int> get_edge_labels(const Graph &g, const bool use_node_labels, const bool use_edge_labels);
    Labels get_node_labels(const Graph &g, const bool use_node_labels, const bool use_edge_labels);

    Graph generate_global_graph(const Graph &g, const bool use_node_labels, const bool use_edge_labels);

    Graph generate_global_graph_malkin(const Graph &g, const bool use_node_labels, const bool use_edge_labels);
