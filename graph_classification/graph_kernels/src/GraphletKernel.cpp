...
{
GraphletKernel::GraphletKernel(const GraphDatabase &graph_database)
                                                       ...
                                                       const bool use_edge_labels)
{
    ...
    // We search for every path of length three, and then distinguish if it is a
    // triangle or a wedge.
                ...
                if (w != u)
                {
                    ...
                    if (g.has_edge(u, w))
                    {
                        if (use_node_labels)
                        {
                            ...
                            {
                                // Map every labeled triangle to a unique
                                // integer.
