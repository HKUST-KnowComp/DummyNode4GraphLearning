# This implementation is adapted from the github repo "gnn-comparison"
# https://github.com/diningphil/gnn-comparison/blob/master/models/graph_classifiers/DiffPool.py
...
class DiffPool(nn.Module):
    ...
    def __init__(self, args):
        super().__init__()
        dim_features = args.num_features
        dim_target = args.num_classes
